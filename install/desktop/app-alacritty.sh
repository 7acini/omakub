...
cp ~/.local/share/omakdeb/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/omakdeb/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/omakdeb/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/omakdeb/install/desktop/set-alacritty-default.sh
